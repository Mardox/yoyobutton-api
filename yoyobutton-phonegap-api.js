...
//  *****************************************/
    ...
    YoYoButton.prototype.getSecurityToken = function(){
        var token = window.localStorage.getItem("security_token");
        if(!token){ 
                //generate a security token
                token = yoyobutton.generateSecurityToken();
                //write the toke to local storage
                window.localStorage.setItem("security_token", security_token);
        }
